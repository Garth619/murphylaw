	...
	<div class="profile_inner">
		...
		<div class="profile_header_wrapper">
			...
			<h1 class="bio_header">
				...
				<span class="upper_header">About</span><!-- upper_header -->
				<span class="lower_header">The Firm</span><!-- lower_header -->
...
<!-- 			<span class="bio_position">Founder / Attorney</span> --><!-- bio_position -->
		...
		<div class="profile_image_wrapper">
			...
			<img src="<?php bloginfo('template_directory');?>/images/int-about-image-desktop.jpg"/>
	...
	<div class="learn_more_play_wrapper">
		...
		<div class="about_play_button">
			...
			<div class="about_play_button_inner">
				...
				<span class="about_tri"></span><!-- about_tri -->
								
			</div><!-- about_play_button_inner -->
							
			<span class="about_gold_square"></span><!-- white_square -->
										
		</div><!-- about_play_button -->
	
		<div class="learn_play_title wistia_embed wistia_async_waichudc62 popover=true popoverContent=html">Learn about the firm</div><!-- learn_play_title -->
		
	</div><!-- learn_more_play_wrapper -->
