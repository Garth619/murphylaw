...
-------------------------------------------------------------- */
 ...
 function load_my_styles_scripts() {
     ...
     if(is_front_page()) {
	      ...
	      wp_enqueue_script( 'jquery-home', get_template_directory_uri() . '/js/homepage-min.js', array('jquery'), '', true );
...
register_nav_menus(array(
    'main_menu' => 'Main Menu',
    'pa_menu' => 'Practice Area Sidebar Menu',
));
...
if (function_exists('acf_add_options_page')) {
    ...
    acf_add_options_page(array(
        'page_title' => 'Community Archive Intro',
        'menu_title' => 'Community Archive Intro',
        'menu_slug' => 'community-archive-intro-general-settings',
        'capability' => 'edit_posts',
        'redirect' => false
    ));
}
